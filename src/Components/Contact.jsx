  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(
        `https://portfoliobackend-wheat.vercel.app/api/v1/send`,
        formData
      );
      ...
      <div className="container">
        ...
        <div className="text-center mb-5">
          <h2 className="fw-bold text-white">
            <span style={{ color: "gold" }}>Get</span> in Touch
          </h2>
        ...
        <div className="row g-4">
          ...
          <div className="col-md-5">
            <div className="contact-info p-4 shadow rounded bg-dark">
              ...
              <p className="text-light">
                <i className="bi bi-geo-alt-fill text-gold"></i> Karachi, Pakistan
              </p>
              <p className="text-light">
                <i className="bi bi-envelope-fill text-gold"></i> shaheeraptech1@gmail.com
              </p>
              <p className="text-light">
                <i className="bi bi-telephone-fill text-gold"></i> +92 310 8530907
              </p>
              <div className="social-icons mt-3">
                <a href="https://www.facebook.com/shaheer.king.7712" target="_blank" className="me-3 text-gold">
                  <i className="bi bi-facebook fs-4"></i>
                </a>
                <a href="https://www.linkedin.com/in/shaheer-ismail-shah-3bb4b634a/" target="_blank" className="me-3 text-gold">
                  <i className="bi bi-linkedin fs-4"></i>
                </a>
                <a href="https://github.com/devShaheer-del" target="_blank" className="text-gold">
