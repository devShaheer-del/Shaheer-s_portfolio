...
const About = () => {
  return (
    <div className="about-container">
      <div className="about-1" data-aos="fade-right">
        <img src={aboutImage} alt="About Me" />
      </div>

      <div className="about-2" data-aos="fade-left">
        <h1>About Me</h1>
        <p>
        ...
        <h4 data-aos="zoom-in"><span style={{ color: "gold" }}>10</span> Projects Complete</h4>
        <a href="/cv/ShaheerIsmail.pdf" download className="mybtn" id="about-btn">Download CV</a>
      </div>

      <div className='about-container-resume' data-aos="fade-up">
        <h1>Resume</h1>
